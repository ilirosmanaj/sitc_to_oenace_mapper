...
TODO: write something about the results. How many items are mapped? why so few? how long it takes etc. Show examples when we find mapping, show that sometimes we fail because
      of no intersections etc
